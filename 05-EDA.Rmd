...
```{r Temperatura_Dataset, message=FALSE, warning=FALSE, echo=FALSE}
...
``` {r co2_vs_temp_processing, message=FALSE, warning=FALSE, echo=FALSE}
...
``` {r 1, fig.cap="Comportamiento anual de la Emisión total de CO~2~ y Temperatura Anómala", message=FALSE, warning=FALSE, echo=FALSE}
...
```{r 2, fig.cap="Gráfico de Dispersión de la Emisión Total de CO~2~ vs Temperatura Anómala", message=FALSE, warning=FALSE, echo=FALSE}
...
``` {r 4, fig.cap="Emisiones per Capita categorizadas por Grupo Económico", message=FALSE, warning=FALSE, echo=FALSE}
...
``` {r 3, fig.cap="Gráfico de Dispersión de la Emisión Total de CO~2~ vs Temperatura Anómala", message=FALSE, warning=FALSE, echo=FALSE}
...
``` {r 5, fig.cap="Correlación GDP vs Emisiones de CO~2~", message=FALSE, warning=FALSE, echo=FALSE, fig.width=12, fig.height=5}
...
``` {r 6, fig.cap="Correlación GDP per Capita vs Emisiones de CO~2~ per Capita", message=FALSE, warning=FALSE, echo=FALSE, fig.width=12, fig.height=5}
...
## Analisis Regional
``` {r climate_change_processing, message=FALSE, warning=FALSE, echo=FALSE, fig.width=12, fig.height=5}
gdp_joined_data %>% 
...
``` {r 7, fig.cap="Emisiones por Región", message=FALSE, warning=FALSE, echo=FALSE, fig.width=12, fig.height=5}
...
``` {r 8, fig.cap="PIB por Región", message=FALSE, warning=FALSE, echo=FALSE, fig.width=12, fig.height=5}
...
``` {r 9, fig.cap="Distribución económica por región", message=FALSE, warning=FALSE, fig.width=12, fig.height=5, echo=FALSE}
country_data %>% 
...
``` {r 10, fig.cap="Distribución de emisiones por región", message=FALSE, warning=FALSE, echo=FALSE, fig.width=12, fig.height=5}
...
``` {r 11, fig.cap="Distribución de emisiones por grupo económico", message=FALSE, warning=FALSE, echo=FALSE, fig.width=12, fig.height=5}
...
``` {r Affected_countries, message=FALSE, warning=FALSE, fig.width=12, fig.height=5, echo=FALSE}
...
```{r 12, fig.cap="Proyección de cambio de temperatura por región", message=FALSE, warning=FALSE, fig.width=12, fig.height=5, echo=FALSE}
...
``` {r 13, fig.cap="Proyección de cambio de temperatura por grupo ecónomico", message=FALSE, warning=FALSE, fig.width=12, fig.height=5, echo=FALSE}
...
``` {r 14, fig.cap="Proyección de cambio de precipitaciones por región", message=FALSE, warning=FALSE, fig.width=12, fig.height=5, echo=FALSE}
...
``` {r 15, fig.cap="Proyección de cambio de precipitaciones por grupo económico", message=FALSE, warning=FALSE, fig.width=12, fig.height=5, echo=FALSE}
